...
<body>
    <div class="container">
        ...
        <div class="patient-info">
            ...
            <div class="patient-info-item">
                <div class="field">
                    ...
                    <div class="value">{{ $pasien->no_rekam_medis ?? 'RM-' . str_pad(rand(1, 999999), 6, '0', STR_PAD_LEFT) }}</div>
                </div>
            </div>
            <div class="patient-info-item">
                <div class="field">
            ...
            <div class="patient-info-item">
                <div class="field">
                    ...
                    <div class="value">{{ $pasien->nomor_telepon ?? '-' }}</div>
                </div>
            </div>
            <div class="patient-info-item">
                <div class="field">
        ...
        <div class="section">
            ...
            <div class="section-content">
                <div class="field">
                    ...
                    <div class="value">{{ $rekam->rawat_jalan_nomorregistrasi }}</div>
                </div>
                <div class="field">
                    <div class="label">Jenis Pasien:</div>
                    <div class="value">{{ $rawatJalan->jenis_pasien }}</div>
                </div>
                <div class="field">
                    <div class="label">Tanggal Pemeriksaan:</div>
                    <div class="value">{{ \Carbon\Carbon::parse($rekam->tanggal_pemeriksaan)->translatedFormat('d F Y') }}</div>
                </div>
                <div class="field">
                    <div class="label">Dokter:</div>
                    <div class="value">{{ $dokter->nama ?? '-' }}</div>
                </div>
                <div class="field">
                    <div class="label">Poliklinik:</div>
                    <div class="value">{{ $rekam->poliklinik ?? 'Poli Umum' }}</div>
                </div>
            </div>
        </div>
        ...
        <div class="section">
            ...
            <div class="section-content">
                <div class="field">
                    ...
                    <div class="value">{{ $rekam->keluhan }}</div>
                </div>
                <div class="field">
                    <div class="label">Hasil Pemeriksaan Perawat:</div>
                    <div class="value">{{ $rekam->pemeriksaanPerawat->catatan_perawatan }}</div>
                </div>
                <div class="field">
                    <div class="label">Hasil Pemeriksaan Lab:</div>
                    <div class="value">{{ $rekam->hasil_asesmen_lab }}</div>
                </div>
                <div class="field">
                    <div class="label">Hasil Pemeriksaan Dokter:</div>
                    <div class="value">{{ $rekam->hasil_asesmen_dokter }}</div>
                </div>
                <div class="field">
                    <div class="label">Diagnosa:</div>
                    <div class="value">{{ $rekam->diagnosa_dokter }}</div>
                </div>
            </div>
        </div>
            ...
            <div class="section-content">
                <div style="display: flex; flex-wrap: wrap; gap: 15px;">
                    <div class="field" style="flex: 1; min-width: 150px;">
                        ...
                        <div class="value">{{ $rekam->pemeriksaanPerawat->berat_badan ?? '-' }} KG</div>
                    </div>
                    <div class="field" style="flex: 1; min-width: 150px;">
                        <div class="label">Suhu:</div>
                        <div class="value">{{ $rekam->pemeriksaanPerawat->suhu ?? '-' }} °C</div>
                    </div>   
                    <div class="field" style="flex: 1; min-width: 150px;">
                        <div class="label">Tekanan Darah:</div>
                        <div class="value">{{ $rekam->pemeriksaanPerawat->tekanan_darah ?? '-' }} mmHg</div>
                    </div>
                    <div class="field" style="flex: 1; min-width: 150px;">
                        <div class="label">Nadi:</div>
                        <div class="value">{{ $rekam->pemeriksaanPerawat->respirasi ?? '-' }} Bpm</div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="section">
            ...
            <div class="section-content">
                <div class="field">
                    ...
                    <div class="value" style="white-space: pre-line;">
                        <ul class="medication-list">
                            @foreach(explode("\n", $rekam->obat) as $obat)
                                @if(trim($obat) !== '')
                                    <li class="medication-item">{{ $obat }}</li>
                                @endif
                            @endforeach
                        </ul>
                    </div>
                ...
                <div class="field">
                    ...
                    <div class="value">{!! $pemeriksaanDokter->catatan_dokter ?? 'Minum obat sesuai anjuran dokter.<br>Jika ada keluhan atau kondisi tidak membaik, segera hubungi dokter.' !!}</div>
        ...
        <div class="signature-area">
            <p>{{ \Carbon\Carbon::parse($rekam->tanggal_pemeriksaan)->translatedFormat('d F Y') }}</p>
        ...
        <div class="footer noprint">
            ...
            <p>© {{ date('Y') }} Rumah Sakit US. Hak Cipta Dilindungi.</p>
        </div>
    </div>
